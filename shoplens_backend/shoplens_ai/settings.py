...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'shoplens_db'),
        'USER': os.getenv('DB_USER', 'shoplens_user'),
        'PASSWORD': os.getenv('DB_PASSWORD', 'hanan@708'),
...
LOGGING = {
    ...
    'handlers': {
        ...
        'rapidapi_file': {
            'level': 'DEBUG',
            'class': 'logging.FileHandler',
            'filename': BASE_DIR / 'rapidapi.log',
            'formatter': 'verbose',
        },
    },
    'root': {
    ...
    'loggers': {
        ...
        'rapidapi': {
            'handlers': ['console', 'rapidapi_file'],
            'level': 'DEBUG',
            'propagate': False,
        },
        'users': {
